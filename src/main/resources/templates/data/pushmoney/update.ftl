...
<body>
        <div style="width: 100%; height: 560px;float: left; float: right">
            ...
            <form class="layui-form" action="" method="post" >
               <table>
                   <tr >
                    <td style="width: 300px;margin: 15px"><input type="text" name="pushid" id="pushid" value="${pushmoney.pushid}"  autocomplete="off" class="layui-input" lay-verify="required\number" onfocus=this.blur()></td>
                   </tr>
                   <tr >
                       <td style="width: 300px;margin: 15px"><input type="text" name="brarank" id="brarank" value="${pushmoney.brarank}"  placeholder="价格" autocomplete="off" class="layui-input" lay-verify="required|number"></td>
                   </tr>
                   <tr ><td style="width: 300px;margin: 15px"><input type="text" name="commission" id="commission" value="${pushmoney.commission}"  placeholder="备注" autocomplete="off" class="layui-input" lay-verify="required"></td>
                   </tr>
                   <tr>
                       <td style="row-span: 2">
